...
void setup() {
  ...
  // Editor port (step 3): boot normally to Home; the editor is reached via the
  // Home "Notes" item (guarded by EDITOR_BLE_SPIKE), which browses /notes and
  // opens the chosen note — or a new blank one — in EditorActivity.
